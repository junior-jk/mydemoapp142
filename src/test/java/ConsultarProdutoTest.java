...
public class ConsultarProdutoTest {
    ...
    public void sampleTest() {
        var el1 = driver
                .findElement(AppiumBy.xpath("(//android.widget.ImageView[@content-desc=\"Product Image\"])[2]"));
        el1.click();
        // driver.executeScript("mobile: pressKey", Map.ofEntries(Map.entry("keycode",
        // 187)));
        var el2 = driver.findElement(AppiumBy.androidUIAutomator(
                "new UiSelector().resourceId(\"com.google.android.apps.nexuslauncher:id/snapshot\").instance(1)"));
        el2.click();
        var el3 = driver.findElement(AppiumBy.androidUIAutomator(
                "new UiSelector().resourceId(\"com.saucelabs.mydemoapp.android:id/productIV\").instance(1)"));
        el3.click();
        // driver.executeScript("mobile: pressKey", Map.ofEntries(Map.entry("keycode",
        // 187)));
        var el4 = driver.findElement(AppiumBy.androidUIAutomator(
                "new UiSelector().resourceId(\"com.google.android.apps.nexuslauncher:id/snapshot\").instance(1)"));
        el4.click();
        var el5 = driver.findElement(AppiumBy.androidUIAutomator(
